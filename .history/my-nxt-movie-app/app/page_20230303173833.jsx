...
export default async function Home() {
  ...
  console.log(latest_res);
  
  return (
    <main>

      <h1 className="text-4xl underline mb-10 font-roboto font-bold">NXT Latest Movies</h1>
      <div className="grid gap-8 grid-cols-fluid">
        
          
           <Movie key={latest_res.id} id={latest_res.id} title={latest_res.title} poster_path={latest_res.poster_path} backdrop_path={latest_res.backdrop_path} release_date={latest_res.release_date}></Movie>
