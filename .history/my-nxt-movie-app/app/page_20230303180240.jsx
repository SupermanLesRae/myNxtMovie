      ...
      <div className="my-20">
        ...
        <div className="grid gap-8 grid-cols-fluid">
            ...
            {tv_res.results.map((movie) => {
              return <Movie key={movie.id} id={movie.id} title={movie.name} poster_path={movie.poster_path} backdrop_path={movie.backdrop_path} release_date={movie.first_air_date}></Movie>
            })}  
