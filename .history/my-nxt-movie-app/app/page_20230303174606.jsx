...
export default async function Home() {
  ...
  const tv_data = await fetch(`https://api.themoviedb.org/3/tv/popularr?api_key=${process.env.API_KEY}&language=en-US&page=1`)
      ...
      <div className="my-20">
        ...
        <div className="grid gap-8 grid-cols-fluid">
            ...
            {tv_res.results.map((tv) => {
              return <Movie key={tv.id} id={tv.id} title={tv.title} poster_path={tv.poster_path} backdrop_path={tv.backdrop_path} release_date={tv.release_date}></Movie>
            })}  
